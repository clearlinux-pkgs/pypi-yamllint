...
Source0  : https://files.pythonhosted.org/packages/46/f2/cd8b7584a48ee83f0bc94f8a32fea38734cefcdc6f7324c4d3bfc699457b/yamllint-1.37.1.tar.gz
...
%prep
%setup -q -n yamllint-1.37.1
cd %{_builddir}/yamllint-1.37.1
pushd ..
cp -a yamllint-1.37.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746459901
