...
Source0  : https://files.pythonhosted.org/packages/a5/ae/2622262d7a5c6af2af85e5edd86f4cf183628e88407942aa0be487b582b6/yamllint-1.29.0.tar.gz
...
%prep
%setup -q -n yamllint-1.29.0
cd %{_builddir}/yamllint-1.29.0
pushd ..
cp -a yamllint-1.29.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673387422
