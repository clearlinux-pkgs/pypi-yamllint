...
Source0  : https://files.pythonhosted.org/packages/91/1c/9e9c7be901a58c82ab437e3e36f0dd0f5ed76687b1ddff9a9519d7c5875d/yamllint-1.34.0.tar.gz
...
%prep
%setup -q -n yamllint-1.34.0
cd %{_builddir}/yamllint-1.34.0
pushd ..
cp -a yamllint-1.34.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707237009
