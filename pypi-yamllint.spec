...
Source0  : https://files.pythonhosted.org/packages/25/7e/704143fd83b6d13d8d146730bd01d10b73d9eb78137f7ee52fec7ed3c594/yamllint-1.30.0.tar.gz
...
%prep
%setup -q -n yamllint-1.30.0
cd %{_builddir}/yamllint-1.30.0
pushd ..
cp -a yamllint-1.30.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679501624
